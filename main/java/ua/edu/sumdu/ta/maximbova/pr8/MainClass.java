...
public class MainClass {
    public static void main (String [] args){
        ...
        */
        ...
        TaskXMLSerializer serializer = new TaskXMLSerializer();
        
        String file = "D:\\Soft\\tasks.xml";
        
        serializer.save(linkedList, file);
        
        ArrayTaskList renewedList = (ArrayTaskList) serializer.load(file);
        
        
        
        for(Task task: renewedList){
